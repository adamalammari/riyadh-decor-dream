...
const botResponses: Record<string, string> = {
  ...
  سعر: "أسعارنا تبدأ من ١٥,٠٠٠ ريال للتصميم الداخلي. للحصول على عرض سعر مخصص، يرجى التواصل معنا على الرقم +966 50 000 0000 📞",
...
const getResponse = (input: string): string => {
  ...
  return "شكراً لتواصلك! سيقوم فريقنا بالرد عليك قريباً. يمكنك أيضاً الاتصال بنا مباشرة على +966 50 000 0000 📱";
};
